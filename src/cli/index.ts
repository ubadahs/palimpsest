...
import { runRunsGcCommand } from "./commands/runs-gc.js";
...
Available commands:
  ...
  runs:gc       Delete superseded run artifacts and unreferenced provenance blobs
...
async function main(): Promise<void> {
  ...
  if (command === "runs:gc") {
    runRunsGcCommand(process.argv.slice(3));
    return;
  }
