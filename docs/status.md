...
| Cited-paper evidence | `m4-evidence` | Done | Real cited-paper DOI resolution (OpenAlex/S2), explicit fetch failure modes, section-aware JATS evidence spans |
...
| Benchmark workflow | `benchmark:*` | Done | Blind export, keyed diff, and approved-delta apply for adjudication datasets |
...
| Reporting (JSON + Markdown) | Done | `src/reporting/` per stage; benchmark diff Markdown added |
