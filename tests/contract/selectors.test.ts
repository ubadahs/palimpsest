...
describe("buildStageInspectorPayload", () => {
  ...
  it("does not discover superseded extraction artifact suffixes", () => {
    writeArtifact("2026-04-07_003_m2-extraction-results.json", {
      seed: baseSeed,
    });
    writeFileSync(
    ...
    expect(artifacts.primaryArtifactPath).toBeUndefined();
